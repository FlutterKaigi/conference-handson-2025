...
└── src
    ...
    │   │   │   ├── reading_support_animation_view_model.dart   （激励一括の状態種別と状態値を定義）
    ...
    │   │   │   │   └── reading_support_animations_widget.dart   激励一括表示のUIウィジェット
    │   │   │   ├── reading
...
何らかのイベントを契機に **激励や一括のメッセージをオーバーラップ表示** させるものですが、  
