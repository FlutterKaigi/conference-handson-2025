// 完成形 UI Widget としてcomplete ディレクトリ配下の実装をインポートさせるバレルパッケージです。
// FIXME 現時点では、各機能ごとのディレクトリから実装パッケージをインポートしています。
// FIXME このため complete ディレクトリ配下に、完成形実装をコピーしてから修正する必要があります。
